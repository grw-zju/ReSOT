...
class Trainer(object):
    ...
    def __init__(self, args, model):
        ...
        self.early_stop_patience = getattr(args, 'early_stop_patience', 1)
    ...
    def _train_epoch(self, train_data, epoch_idx):
        ...
        for batch_idx, data in enumerate(iter_data):
            ...
            if self.model.diversity_loss_weight > 0:
                with torch.no_grad():
                    self.model.revive_dead_codes(self.model.encoder(data))
    ...
    def fit(self, data):
        ...
        for epoch_idx in range(self.epochs):
            ...
            if (epoch_idx + 1) % self.eval_step == 0:
                ...
                if cur_eval_step >= self.early_stop_patience:
                    self.logger.info(set_color(f"Early stopping at epoch {epoch_idx} after {self.early_stop_patience} eval steps without improvement", "red"))
                    break
